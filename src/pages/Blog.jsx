...
const Blog = () => {
    ...
    console.log(blog)
    const { cover_image,tags, comments_count, id, title, description, published_at, reading_time_minutes, public_reactions_count } = blog;
        ...
        <div className="max-w-4xl px-6 py-16 mx-auto space-y-12">
            <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                ...
                <div className="flex items-start -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                    ...
                    {/* bookMarks button */}
                    <div onClick={() =>handleBookMark(blog)} className=' flex justify-center items-center  bg-primary p-4 rounded-full bg-opacity-20 cursor-pointer ml-5'>
